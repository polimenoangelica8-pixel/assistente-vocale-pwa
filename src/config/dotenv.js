...
export const config = {
  ...
  deepgram: {
    ...
    ttsVoice: process.env.DEEPGRAM_TTS_VOICE || 'aura-2-cinzia-it',
  ...
  // Sito ASSOCAF: endpoint che registra gli appuntamenti nel database.
  assocaf: {
    apiUrl: (process.env.ASSOCAF_API_URL || 'https://assocaf.com').replace(/\/$/, ''),
